...
// 
// 状況によって設定変更するのは一般的に2と5、必要に応じ3, 4である．他は通常は設定変更不要
// 2を設定変更したらEEPROMに保存されたデータを正しく読み出すことができなくなる
// ので必要なら変更前に読み出しておく．
// 5は変更してもEEPROMに保存されたデータを正しく読み出すことが可能
// 1は複数ロガーを使用する場合に最初に一回設定するだけでよい。
// 6はセンサライブラリを作成する場合以外は基本的に変更不要
// 7, 8は基本的に変更不要
// 9は必要なら設定する（毎回起動時に時刻設定を行う）。
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////
// SHT-31/35温湿度センサを使う場合 秋月電子通商のライブラリ使用。定義名がAE_SHT31だとクラス名と同じためコンパイルエラーとなる。
// 2個同時に設定，使用可能
/////////////////////////////////
...
/////////////////////////////////
// SHT-31/35温湿度センサを使う場合 Sensirionのライブラリ使用。純正だがフラッシュメモリ使用量が大きい。
// 2個同時に設定，使用可能
/////////////////////////////////
...
/////////////////////////////////
// SHT-85温湿度センサを使う場合．秋月電子通商のAE-SHT31用ライブラリ使用
/////////////////////////////////
//#define SHT8X_A
/////////////////////////////////

/////////////////////////////////
// SHT-85温湿度センサを使う場合．Sensirionのライブラリ使用
/////////////////////////////////
//#define SHT8X_S
...
/////////////////////////////////
// HTU21温湿度センサを使う場合。実はSHT-21と同じライブラリが使えるようだ。
/////////////////////////////////
//#define HTU21
...
/////////////////////////////////////////////////////////////////
//            温度計の補助機能使用設定
//            必要に応じ、SEKISANかMIN_MAXどちらか一方設定できる。
/////////////////////////////////////////////////////////////////
//#define SEKISAN   // 積算温度計として使う場合に設定
//#define MIN_MAX  5  // 最低最高温度計として使用する場合に設定　数字は最低最高の表示日数
/////////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////////
//            ボタンを押した時の処理画面等に関する設定
//            他の設定に応じて自動的に設定されるので変更不要
/////////////////////////////////////////////////////////////////
//               積算温度計として使用する場合
/////////////////////////////////////////////////////////////////
#ifdef SEKISAN        // 積算処理数が5の場合は0-4が積算の切替で5が設定確認、6が処理メニュー
...
//               最低最高温度計として使用する場合
/////////////////////////////////////////////////////////////////
#elif MIN_MAX               // gDispMode 0は通常の温度表示、1以降は最低最高温度表示
#ifdef DUAL_SENSORS         // センサが2本の場合は1日につきgDispModeの番号が2つ必要になる（2本分をLCD1画面に表示しきれない）。
#define MENU_NO (MIN_MAX * 2 + 2)
#else
#define MENU_NO (MIN_MAX + 2)
#endif
#define CONFIG_NO (MENU_NO - 1)

/////////////////////////////////////////////////////////////////
//               普通の単純な温度計として使用する場合
/////////////////////////////////////////////////////////////////
#else
#define MENU_NO          2 // LCDで最後の画面のgDispModeの番号。単純な温度計では基本画面(0)と設定確認画面(1)、処理メニュー画面(2)の3つ
#define CONFIG_NO        1 // ロガー設定内容を表示する場合のgDispModeの番号。基本的にMENU＿NOの前
#endif                     // センサ情報が多くて1画面では足りない場合は、複数の別画面表示とすることも可能
                           // その場合はCONFIG_NOやMENU_NOをずらし、空いたgDispModeに対応する表示をlcdTime(), lcdData()等で定義する。
/////////////////////////////////////////////////////////////////
...
#define THERMISTOR_ADC2     2 // サーミスタ測定ピン２
